...
class point_warper
{
    ...
    public Vector mesh_formation(point apoint[], int i, int j, int k)/*4 corner points  identifier siw sih*/
        ...
        mshS = calc_m4(mshS);creates a mesh when provided with the markers*/
    {
        ...
        for(int l4 = 0; l4 < k4; l4++)
        {
            ...
            {
                point point7 = mesh2.m1;
                point point13 = mesh2.m2;
                point point18 = mesh2.m3;
                point point22 = nearest_point(point7, point13, point18, apoint, i);
                vector.addElement(new mesh(point7, point13, point22, 1000));
            }
            if(count_meshes_with_link(mesh2.m2, mesh2.m3, vector, k4) == 1)
            {
                point point8 = mesh2.m2;
                point point14 = mesh2.m3;
                point point19 = mesh2.m1;
                point point23 = nearest_point(point8, point14, point19, apoint, i);
                vector.addElement(new mesh(point8, point14, point23, 1000));
            }
            if(count_meshes_with_link(mesh2.m3, mesh2.m1, vector, k4) == 1)
            {
                point point9 = mesh2.m3;
                point point15 = mesh2.m1;
                point point20 = mesh2.m2;
                point point24 = nearest_point(point9, point15, point20, apoint, i);
...
label0:
        ...
        {
            point point10 = apoint[i + i5];
            point point16 = apoint[i + (i5 + 1) % 4];
            int j5 = 0;
            do
            {
                if(j5 >= i)
                    continue label0;
                point point21 = apoint[j5];
    ...
    /*true if point p1 is outside else returns false.
Description: detects whether point 'p1' is outside all meshes
*/
    {
        boolean flag = true;
        int j = point1.x;
...
Description: detects whether point 'pt' is inside the region pqr.
*/
    {
        boolean flag = true;
...
Description: identifies corner point of Image that is nearest to link 'p1p2'
*/  {
