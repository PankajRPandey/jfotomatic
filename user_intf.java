...
import layouts.*; //user-defined package......
...
label4:
            ...
            if(ae.getSource() == morph2)
            {
                ...
                if(Swindow2 == null || !Swindow2.isVisible())
                {
                    String s8;
                    if(algorithm == 1)
                        s8 = "Choose either \" Point Warping \" algorithm in \" Enter details \" tab \nand then provide a source image";
                    else
