...
class morph
{
    ...
    public Image[] mainMorph(Image image, Image image1, point apoint[], point apoint1[], int i, int j, String s)
    {
        ...
        if(image1 != null)
        {
            ...
            catch(InterruptedException interruptedexception1) { }/*taking cormer point in to account for deatination */
    ...
    /*: -1 if 'point p' is outside to all meshes otherwise returns index of mesh that encloses the 'point p' .
Description: checks whether 'point p' is inside any mesh.
*/
    {
        int i = -1;
        point_warper point_warper1 = new point_warper();
